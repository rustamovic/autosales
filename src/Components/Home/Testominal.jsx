...
import loveIllustrationImageSrc from "../../Assets/PNG/chevro.png";
...
const Description = tw.p`mt-6 text-center md:text-left text-sm md:text-base lg:text-lg font-medium leading-relaxed text-blue-400`;
...
const CustomerTitle = tw.p`font-medium text-blue-600`;
