...
import "./BuyCar.css";
import DesignIllustration from "../../Assets/PNG/ferrariB.webp";
import Func from "../Home/SendFunc/tradefunc";
...
const Actions = styled.div`
  ${tw`relative max-w-md text-center mx-auto lg:mx-0 bg-blue-500 p-10`}
  input {
